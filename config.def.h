...
static char *font2[] = { "JetBrainsMono Nerd Font:style=medium:pixelsize=18:antialias=true:autohint=true", "blobmoji:pixelsize=18:antialias=true:autohint=true" }; /* enable this if u have libxft-bgra and blobmoji font! */
