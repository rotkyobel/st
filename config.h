 ...
 */
static char *font = "Sarasa Term SC:style=semibold:pixelsize=18";
static char *font2[] = { "Sarasa Term SC:style=semibold:pixelsize=18:antialias=true:autohint=true", "JetBrainsMono Nerd Font:pixelsize=18:style=medium", "JoyPixels:pixelsize=18:antialias=true:autohint=true" }; /* enable this if u have libxft-bgra and blobmoji font! */
